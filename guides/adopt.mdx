...
The installer then asks where to keep backups. Pick your provider and paste the bucket name and access key ([Set up backup storage](/docs/guides/storage) shows where to find them). For the passphrase, choose **Use my own passphrase** and paste the one from your secret manager. Input is hidden.
...
<Accordions>
<Accordion title="Automate it: pass the secrets from your secret manager">
