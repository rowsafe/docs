...
- **Not exposed at all:** enrollment tokens, API keys, removing hosts or databases, forks, plan changes, and agent update settings.
...
| Tool | Parameters |
|---|---|
| `get_database`, `safety_check`, `list_restore_points`, `standby_status` | `database` (required) |
