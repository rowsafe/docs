...
Use `--json` for every detail, including the start of the recovery window. AI agents get the same check through the `safety_check` [MCP tool](/docs/reference/mcp).
