...
- **a [restore point](/docs/concepts/restore-points)**: a named moment you marked earlier.

Rowsafe proves every week that restoring works, with a [restore drill](/docs/concepts/restore-drills).
